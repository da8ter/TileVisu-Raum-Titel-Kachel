...
class TileVisuRoomHeaderTile extends IPSModule
{
    public function Create()
    {
        ...
        $this->RegisterPropertyFloat('InfoSchriftgroesse', 20);
        $this->RegisterPropertyBoolean('InfoMenueSwitch', 1);
        $this->RegisterPropertyFloat('InfoMenueSchriftgroesse', 12);
        ...
        $this->RegisterPropertyFloat('RaumnameSchriftgroesse', 50);
        $this->RegisterPropertyInteger('RaumnameSchriftfarbe', 0xFFFFFF);
        $this->RegisterPropertyInteger('Schalter1', 0);
        $this->RegisterPropertyFloat('Schalter1Schriftgroesse', 12);
        ...
        $this->RegisterPropertyFloat('Schalter2Schriftgroesse', 12);
        ...
        $this->RegisterPropertyFloat('Schalter3Schriftgroesse', 12);
        ...
        $this->RegisterPropertyFloat('Schalter4Schriftgroesse', 12);
